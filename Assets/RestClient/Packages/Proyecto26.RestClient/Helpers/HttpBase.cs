...
namespace Proyecto26
{
    public static class HttpBase
    {
        ...
        {
            return new RequestException(request.error, (request.result == UnityWebRequest.Result.ConnectionError), (request.result == UnityWebRequest.Result.ConnectionError), request.responseCode, options.ParseResponseBody ? request.downloadHandler.text : "body not parsed");
        }
